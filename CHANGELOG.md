...
- Reworked the ADLC Operating Model into a governance matrix.
...
- Strengthened canonical, hreflang, robots, sitemap, Open Graph, Twitter, and JSON-LD metadata.
- Added a changelog page and exposed it through the version badge and footer.

## V1.0 - April 2026

- Initial public version of the ADLC Manifesto.
- Added core principles, lifecycle framing, multilingual pages, PaperCSS visual direction, and the first definition of ADLC as a governed, tool-agnostic lifecycle for agentic delivery.
